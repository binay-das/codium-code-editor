    ...
    return (
        <section className="py-32 relative overflow-hidden bg-zinc-950">
            ...
            <div className="w-full max-w-5xl mx-auto px-6">
                ...
                >
                    <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">Everything you need to <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">code better</span></h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="group relative p-8 rounded-2xl border border-zinc-800 bg-zinc-900/50 hover:bg-zinc-900/80 transition-all duration-300 hover:border-zinc-700"
                        >
                            <div className={`absolute inset-0 bg-gradient-to-br ${feature.gradient} opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl`} />

                            <div className="relative z-10">
                                <div className="mb-6 inline-flex p-3 rounded-lg bg-zinc-950 border border-zinc-800 shadow-sm">
                                    {feature.icon}
                                </div>
