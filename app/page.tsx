        ...
        <section className="relative w-full max-w-4xl px-4 pb-24">
          <div className="relative overflow-hidden rounded-xl border border-zinc-800 bg-zinc-950 shadow-2xl">
            <div className="flex items-center gap-2 border-b border-zinc-800 bg-zinc-900/50 px-4 py-3">
              ...
              <div className="ml-2 text-xs text-zinc-500">example.ts</div>
            </div>
            <div className="p-4 font-mono text-sm text-zinc-300">
              <div className="flex">
                <span className="w-8 select-none text-zinc-700">1</span>
                <span><span className="text-purple-400">interface</span> <span className="text-yellow-200">User</span> {"{"}</span>
              </div>
              <div className="flex">
                <span className="w-8 select-none text-zinc-700">2</span>
                <span>  <span className="text-blue-300">id</span>: <span className="text-red-300">string</span>;</span>
              </div>
              <div className="flex">
                <span className="w-8 select-none text-zinc-700">3</span>
                <span>  <span className="text-blue-300">name</span>: <span className="text-red-300">string</span>;</span>
              </div>
              <div className="flex">
                <span className="w-8 select-none text-zinc-700">4</span>
                <span>  <span className="text-blue-300">role</span>: <span className="text-green-300">'admin'</span> | <span className="text-green-300">'member'</span>;</span>
              </div>
              <div className="flex">
              ...
              <div className="flex">
                ...
                <span><span className="text-purple-400">const</span> <span className="text-blue-400">activeUser</span>: <span className="text-yellow-200">User</span> = {"{"}</span>
              </div>
              <div className="flex">
                <span className="w-8 select-none text-zinc-700">8</span>
                <span>  <span className="text-blue-300">id</span>: <span className="text-green-300">'u_123'</span>,</span>
              </div>
              <div className="flex">
                <span className="w-8 select-none text-zinc-700">9</span>
                <span>  <span className="text-blue-300">name</span>: <span className="text-green-300">'Binay'</span>,</span>
              </div>
              <div className="flex">
                <span className="w-8 select-none text-zinc-700">10</span>
                <span>  <span className="text-blue-300">role</span>: <span className="text-green-300">'admin'</span></span>
              </div>
              <div className="flex">
